...
//
// MODIFIED: Added static OnPoseLandmarksDetected event so PoseLandmarkBridge
...
namespace Mediapipe.Unity.Sample.PoseLandmarkDetection
{
    public class PoseLandmarkerRunner : VisionTaskApiRunner<PoseLandmarker>
    {
        ...
        // ── Static event — PoseLandmarkBridge subscribes to this ──
        public static event Action<PoseLandmarkerResult> OnPoseLandmarksDetected;
                ...
                switch (taskApi.runningMode)
                {
                    case Tasks.Vision.Core.RunningMode.IMAGE:
                        if (taskApi.TryDetect(image, imageProcessingOptions, ref result))
                        {
                            ...
                            OnPoseLandmarksDetected?.Invoke(result);  // ← fire event
                        }
                        else
                        {
                            _poseLandmarkerResultAnnotationController.DrawNow(default);
                            OnPoseLandmarksDetected?.Invoke(default); // ← fire event
                        }
